...
async def _model_state(request: Request) -> str:
    ...
    # A server started with `--api-key` answers an unauthenticated probe with a
    # 401, and reporting a healthy model as "http 401" is a false alarm the
    # runbook would send someone chasing.
